...
CUDA_VISIBLE_DEVICES=${GPUS} python train.py  --async_distributed --available_gpus ${GPUS} --num_actors 16 \
  --algo_name PopArtIMPALA_attention --positional_embedding none --env_name meltingpot --map_name coop_mining --map_layout small_map --seed 1 --agent_roles "default, default, default" \
