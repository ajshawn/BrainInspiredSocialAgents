...
#exp_dir='results/PopArtIMPALA_attention_multihead_self_supervision_2_meltingpot_coop_mining_2025-10-17_20:06:05.608232'

# # baseline 
# CUDA_VISIBLE_DEVICES=${GPUS} python train.py  --async_distributed --available_gpus ${GPUS} --num_actors 16 \
#   --algo_name PopArtIMPALA \
#   --env_name meltingpot --map_name coop_mining --map_layout original --seed 6 --agent_roles "default, default, default" \
...
#   --env_name meltingpot --map_name coop_mining --map_layout original --seed 2 --agent_roles "default, default, default" \
#   --dense_ore_regrow True --iron_rate 0.00012 --gold_rate 0.00008 \
