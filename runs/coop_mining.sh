...
exp_dir='results/PopArtIMPALA_1_meltingpot_coop_mining_2025-06-13_11:31:14.677056'
CUDA_VISIBLE_DEVICES=${GPUS} python train.py  --async_distributed --available_gpus ${GPUS} --num_actors 16 \
  --algo_name PopArtIMPALA --positional_embedding learnable --add_selection_vector True \
