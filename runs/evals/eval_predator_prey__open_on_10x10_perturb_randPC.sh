...
EXP_DIR_PREFIX="results/PopArtIMPALA_1_meltingpot_predator_prey__open_2025-02-24_16:09:49.096441"
EVN_NAME="predator_prey__simplified10x10_OneVsOne"
MAP_NAME=""
ALGORITHM_NAME="PopArtIMPALA"
#TIME_STAMP="2025-01-07_12:11:32.926962"
TIME_STAMP="2025-02-24_16:09:49.096441"
GPUS=""
      ...
      do
        ...
        (
          ...
          CUDA_VISIBLE_DEVICES="${GPUS}" python evaluate.py \
            ...
            --agent_param_indices "${predator_param_index}, ${prey_param_index}" \
            --num_episodes 100 \
            --plsc_dim_to_perturb $randPCDim \
            --agent_to_perturb "${perturb}" \
            --recurrent_dim $ReccurrentDim \
            --plsc_decomposition_dict_path "${EXP_DIR_PREFIX}${ckp}/pickles/randPC_remTop10PLSCs.pkl"
        ...
        echo "Sleeping 15 seconds before next PLSC job..."
        sleep 15
