...
conda install -c conda-forge cudatoolkit=11.8 cudnn=8.2
which python

pip install -r requirements_Qin.txt
...
#git clone https://github.com/google-deepmind/acme/tree/0.4.0
#cd acme
#git checkout 0.4.0
#git reset --hard 4525ade7015c46f33556e18d76a8d542b916f264
git clone --branch 0.4.0 https://github.com/google-deepmind/acme.git acme
cd acme
pip install -e .
cd ..
