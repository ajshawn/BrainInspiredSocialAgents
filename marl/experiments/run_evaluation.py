...
def run_evaluation(
    ...
    scenario_spec: ma_specs.MAEnvironmentSpec = ma_specs.MAEnvironmentSpec(environment)
    ...
    def select_action(self, observations):
        if self._states is None:
            ...
            self.selected_params = (
                jnp.arange(self.n_agents) % self.n_params
            ) + self.agent_idx_offset
            self.episode_params = ma_utils.select_idx(
                self.loaded_params, self.selected_params
            )
